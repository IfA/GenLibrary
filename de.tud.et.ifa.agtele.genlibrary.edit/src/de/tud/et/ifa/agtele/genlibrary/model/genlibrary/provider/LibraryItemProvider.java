...
/**
 * This is the item provider adapter for a {@link de.tud.et.ifa.agtele.genlibrary.model.genlibrary.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LibraryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Library_Checksum_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Library_Checksum_feature", "_UI_Library_type"),
				 GenLibraryPackage.Literals.LIBRARY__CHECKSUM,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GenLibraryPackage.Literals.LIBRARY__ITEMS);
		}
	...
	public String getText(Object object) {
		String label = ((Library)object).getChecksum();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GenLibraryPackage.Literals.LIBRARY__ITEMS,
				 GenLibraryFactory.eINSTANCE.createItem()));
	}
