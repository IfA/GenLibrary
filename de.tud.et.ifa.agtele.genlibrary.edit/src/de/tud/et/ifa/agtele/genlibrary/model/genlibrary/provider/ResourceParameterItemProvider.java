...
/**
 * This is the item provider adapter for a {@link de.tud.et.ifa.agtele.genlibrary.model.genlibrary.ResourceParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GenLibraryPackage.Literals.RESOURCE_PARAMETER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addNewPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceParameter_newPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceParameter_newPath_feature", "_UI_ResourceParameter_type"),
				 GenLibraryPackage.Literals.RESOURCE_PARAMETER__NEW_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
