 ...
 * <ul>
 *   <li>{@link de.tud.et.ifa.agtele.movisa.library.model.Library.impl.LibraryImpl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link de.tud.et.ifa.agtele.movisa.library.model.Library.impl.LibraryImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LibraryImpl extends EObjectImpl implements Library {
	...
	public void setChecksum(String newChecksum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.LIBRARY__CHECKSUM, oldChecksum, checksum));
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<Item>(Item.class, this, LibraryPackage.LIBRARY__ITEMS);
		}
		return items;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LibraryPackage.LIBRARY__ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LibraryPackage.LIBRARY__CHECKSUM:
				return getChecksum();
			case LibraryPackage.LIBRARY__ITEMS:
				return getItems();
		}
