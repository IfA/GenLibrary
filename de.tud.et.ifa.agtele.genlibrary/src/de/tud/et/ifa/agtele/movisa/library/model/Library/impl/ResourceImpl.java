 ...
 * <ul>
 *   <li>{@link de.tud.et.ifa.agtele.movisa.library.model.Library.impl.ResourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.tud.et.ifa.agtele.movisa.library.model.Library.impl.ResourceImpl#getNewPath <em>New Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceImpl extends EObjectImpl implements Resource {
	...
	public void setNewPath(String newNewPath) {
		...
		newPath = newNewPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LibraryPackage.RESOURCE__NEW_PATH, oldNewPath, newPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LibraryPackage.RESOURCE__NAME:
				return getName();
			case LibraryPackage.RESOURCE__NEW_PATH:
				return getNewPath();
		}
