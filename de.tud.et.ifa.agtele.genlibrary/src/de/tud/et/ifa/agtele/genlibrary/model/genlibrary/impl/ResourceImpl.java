 ...
 * <ul>
 *   <li>{@link de.tud.et.ifa.agtele.genlibrary.model.genlibrary.impl.ResourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.tud.et.ifa.agtele.genlibrary.model.genlibrary.impl.ResourceImpl#getNewPath <em>New Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceImpl extends EObjectImpl implements Resource {
	...
	protected EClass eStaticClass() {
		return GenLibraryPackage.Literals.RESOURCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenLibraryPackage.RESOURCE__NAME, oldName, name));
	}
	...
	public void setNewPath(String newNewPath) {
		...
		newPath = newNewPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenLibraryPackage.RESOURCE__NEW_PATH, oldNewPath, newPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GenLibraryPackage.RESOURCE__NAME:
				return getName();
			case GenLibraryPackage.RESOURCE__NEW_PATH:
				return getNewPath();
		}
