...
public class ItemImpl extends EObjectImpl implements Item {
	...
	protected EClass eStaticClass() {
		return GenLibraryPackage.Literals.ITEM;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenLibraryPackage.ITEM__KEY, oldKey, key));
	}
	...
	public void setPath(String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenLibraryPackage.ITEM__PATH, oldPath, path));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenLibraryPackage.ITEM__VERSION, oldVersion, version));
	}
